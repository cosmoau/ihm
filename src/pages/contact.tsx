...
import { Stack, Text, View, Box, Badge, Element } from '@withcosmo/design-system';
      ...
      <View inverted container top={7} bottom={8}>
        <Stack direction='row'>
          <Stack direction='column' width={80} offset={10} widthTablet={100} offsetTablet={0} align='center'>
            ...
            <Badge theme='pink'>All enquiries are facilitated by our parent company, Cosmo.</Badge>
            <Element top={6}>
              <Badge icon={<EnvelopeSimple weight='duotone' />} inline={5}>
                <a href='contact@cosmogroup.io'>contact@cosmogroup.io</a>
              </Badge>
              <Badge icon={<Phone weight='duotone' />} inline={5}>
